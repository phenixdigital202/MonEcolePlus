...
export function DashboardHeader({ title, subtitle, onMenuToggle, children }: DashboardHeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center gap-4 border-b border-slate-100/80 bg-white/80 backdrop-blur-lg px-4 md:px-6 shadow-sm glass print:hidden no-print">
      {/* Mobile menu button */}
      <button
